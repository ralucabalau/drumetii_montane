...
<body>
  ...
  <?php
    ...
    $_SESSION['lastPage']= 'http://localhost/drumetii/trasee.php';
    ...
    if(isset($_REQUEST['logout'])){
      ...
      echo"<script>window.location.href='http://localhost/drumetii/trasee.php'</script>";
    }
    ...
    $trails = $trailsMethods->getTrails(['limit'=>'']);

    if ($trails->num_rows > 0)
    {
      echo "<div class='cardsContainer allTrails'>";
